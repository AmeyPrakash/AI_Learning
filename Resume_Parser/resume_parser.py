...
try:
    ...
    raise SystemExit(
        f"Missing dependency: {missing_module}. Run this project with "
...
def get_groq_client() -> Groq:
    ...
    if not api_key:
        raise ValueError(
            "Groq API key not found. Add GROQ_API_KEY=your_key_here to the parent .env file."
        )
...
#extracting PDf data using fitz
